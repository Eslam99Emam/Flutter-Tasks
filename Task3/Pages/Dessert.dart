...
class Dessert_Page extends StatefulWidget {
  const Dessert_Page({super.key});

  @override
  State<Dessert_Page> createState() => _Dessert_PageState();
}

class _Dessert_PageState extends State<Dessert_Page> {
  @override
      ...
      body: Padding(
        ...
        child: GridView.builder(
            ...
            itemBuilder: (BuildContext context, i) {
              return CustomCard("Dessert ${i}", (i + 1) % 3 == 0);
            }),
      ),
    );
  }
