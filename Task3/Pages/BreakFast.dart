...
class Breakfast_Page extends StatefulWidget {
  const Breakfast_Page({super.key});

  @override
  State<Breakfast_Page> createState() => _Breakfast_PageState();
}

class _Breakfast_PageState extends State<Breakfast_Page> {
  @override
      ...
      body: Padding(
        ...
        child: GridView.builder(
            ...
            itemBuilder: (BuildContext context, i) {
              return CustomCard("Breakfast ${i}", (i + 1) % 3 == 0);
            }),
      ),
    );
  }
